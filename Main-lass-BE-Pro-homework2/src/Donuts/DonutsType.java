...
public enum DonutsType {
    ...
    AMERICAIN("American doughnuts are often coated with sugar or glazed with different flavors such as chocolate, vanilla, or maple1 ",13,57,30),
    ...
    return " 1 desc : " + this.description + " sugar : " + this.sugar + " flour : " + this.flour + " water : " + this.water;
 }
}